...
xiaoli is an npm global CLI tool that acts as your AI Agent in the terminal. Unlike traditional AI assistants, xiaoli **asks all questions first, then executes** — it won't touch a single line of code until all ambiguities are resolved.
